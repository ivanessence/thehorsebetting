...
-- Дамп структуры базы данных information_schema
...
-- Дамп структуры для таблица information_schema.CHARACTER_SETS
...
-- Дамп структуры для таблица information_schema.COLLATIONS
...
-- Дамп структуры для таблица information_schema.COLLATION_CHARACTER_SET_APPLICABILITY
...
-- Дамп структуры для таблица information_schema.COLUMNS
...
-- Дамп структуры для таблица information_schema.COLUMN_PRIVILEGES
...
-- Дамп структуры для таблица information_schema.ENGINES
...
-- Дамп структуры для таблица information_schema.EVENTS
...
-- Дамп структуры для таблица information_schema.FILES
...
-- Дамп структуры для таблица information_schema.GLOBAL_STATUS
...
-- Дамп структуры для таблица information_schema.GLOBAL_VARIABLES
...
-- Дамп структуры для таблица information_schema.INNODB_BUFFER_PAGE
...
-- Дамп структуры для таблица information_schema.INNODB_BUFFER_PAGE_LRU
...
-- Дамп структуры для таблица information_schema.INNODB_BUFFER_POOL_STATS
...
-- Дамп структуры для таблица information_schema.INNODB_CMP
...
-- Дамп структуры для таблица information_schema.INNODB_CMPMEM
...
-- Дамп структуры для таблица information_schema.INNODB_CMPMEM_RESET
...
-- Дамп структуры для таблица information_schema.INNODB_CMP_PER_INDEX
...
-- Дамп структуры для таблица information_schema.INNODB_CMP_PER_INDEX_RESET
...
-- Дамп структуры для таблица information_schema.INNODB_CMP_RESET
...
-- Дамп структуры для таблица information_schema.INNODB_FT_BEING_DELETED
...
-- Дамп структуры для таблица information_schema.INNODB_FT_CONFIG
...
-- Дамп структуры для таблица information_schema.INNODB_FT_DEFAULT_STOPWORD
...
-- Дамп структуры для таблица information_schema.INNODB_FT_DELETED
...
-- Дамп структуры для таблица information_schema.INNODB_FT_INDEX_CACHE
...
-- Дамп структуры для таблица information_schema.INNODB_FT_INDEX_TABLE
...
-- Дамп структуры для таблица information_schema.INNODB_LOCKS
...
-- Дамп структуры для таблица information_schema.INNODB_LOCK_WAITS
...
-- Дамп структуры для таблица information_schema.INNODB_METRICS
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_COLUMNS
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_DATAFILES
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_FIELDS
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_FOREIGN
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_FOREIGN_COLS
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_INDEXES
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_TABLES
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_TABLESPACES
...
-- Дамп структуры для таблица information_schema.INNODB_SYS_TABLESTATS
...
-- Дамп структуры для таблица information_schema.INNODB_TRX
...
-- Дамп структуры для таблица information_schema.KEY_COLUMN_USAGE
...
-- Дамп структуры для таблица information_schema.OPTIMIZER_TRACE
...
-- Дамп структуры для таблица information_schema.PARAMETERS
...
-- Дамп структуры для таблица information_schema.PARTITIONS
...
-- Дамп структуры для таблица information_schema.PLUGINS
...
-- Дамп структуры для таблица information_schema.PROCESSLIST
...
-- Дамп структуры для таблица information_schema.PROFILING
...
-- Дамп структуры для таблица information_schema.REFERENTIAL_CONSTRAINTS
...
-- Дамп структуры для таблица information_schema.ROUTINES
...
-- Дамп структуры для таблица information_schema.SCHEMATA
...
-- Дамп структуры для таблица information_schema.SCHEMA_PRIVILEGES
...
-- Дамп структуры для таблица information_schema.SESSION_STATUS
...
-- Дамп структуры для таблица information_schema.SESSION_VARIABLES
...
-- Дамп структуры для таблица information_schema.STATISTICS
...
-- Дамп структуры для таблица information_schema.TABLES
...
-- Дамп структуры для таблица information_schema.TABLESPACES
...
-- Дамп структуры для таблица information_schema.TABLE_CONSTRAINTS
...
-- Дамп структуры для таблица information_schema.TABLE_PRIVILEGES
...
-- Дамп структуры для таблица information_schema.TRIGGERS
...
-- Дамп структуры для таблица information_schema.USER_PRIVILEGES
...
-- Дамп структуры для таблица information_schema.VIEWS
...
-- Дамп структуры базы данных horsebetting
DROP DATABASE IF EXISTS `horsebetting`;
CREATE DATABASE IF NOT EXISTS `horsebetting` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `horsebetting`;


-- Дамп структуры для таблица horsebetting.bets
DROP TABLE IF EXISTS `bets`;
CREATE TABLE IF NOT EXISTS `bets` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `amount` float NOT NULL DEFAULT '0',
  `raceID` int(10) NOT NULL DEFAULT '0',
  `horseID` int(10) NOT NULL DEFAULT '0',
  `userID` int(10) NOT NULL DEFAULT '0',
  `status` int(10) NOT NULL DEFAULT '0',
  `coefficent` float NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
...
-- Дамп структуры для таблица horsebetting.horses
...
-- Дамп структуры для таблица horsebetting.news
...
-- Дамп структуры для таблица horsebetting.races
DROP TABLE IF EXISTS `races`;
CREATE TABLE IF NOT EXISTS `races` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `destination` float unsigned DEFAULT '0',
  `date` datetime DEFAULT NULL,
  `horses` text,
  `status` text,
  `idWinnerHorse` int(11) DEFAULT NULL,
  `koef` text,
...
-- Дамп структуры для таблица horsebetting.users
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `deleted` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '0-active, 1-deleted',
  `deletedDate` date DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Дамп структуры базы данных mysql
DROP DATABASE IF EXISTS `mysql`;
CREATE DATABASE IF NOT EXISTS `mysql` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mysql`;


-- Дамп структуры для таблица mysql.columns_priv
...
-- Дамп структуры для таблица mysql.db
...
-- Дамп структуры для таблица mysql.event
...
-- Дамп структуры для таблица mysql.func
...
-- Дамп структуры для таблица mysql.general_log
...
-- Дамп структуры для таблица mysql.help_category
...
-- Дамп структуры для таблица mysql.help_keyword
...
-- Дамп структуры для таблица mysql.help_relation
...
-- Дамп структуры для таблица mysql.help_topic
...
-- Дамп структуры для таблица mysql.innodb_index_stats
...
-- Дамп структуры для таблица mysql.innodb_table_stats
...
-- Дамп структуры для таблица mysql.ndb_binlog_index
...
-- Дамп структуры для таблица mysql.plugin
...
-- Дамп структуры для таблица mysql.proc
...
-- Дамп структуры для таблица mysql.procs_priv
...
-- Дамп структуры для таблица mysql.proxies_priv
...
-- Дамп структуры для таблица mysql.servers
...
-- Дамп структуры для таблица mysql.slave_master_info
...
-- Дамп структуры для таблица mysql.slave_relay_log_info
...
-- Дамп структуры для таблица mysql.slave_worker_info
...
-- Дамп структуры для таблица mysql.slow_log
...
-- Дамп структуры для таблица mysql.tables_priv
...
-- Дамп структуры для таблица mysql.time_zone
...
-- Дамп структуры для таблица mysql.time_zone_leap_second
...
-- Дамп структуры для таблица mysql.time_zone_name
...
-- Дамп структуры для таблица mysql.time_zone_transition
...
-- Дамп структуры для таблица mysql.time_zone_transition_type
...
-- Дамп структуры для таблица mysql.user
...
-- Дамп структуры базы данных performance_schema
...
-- Дамп структуры для таблица performance_schema.accounts
...
-- Дамп структуры для таблица performance_schema.cond_instances
...
-- Дамп структуры для таблица performance_schema.events_stages_current
...
-- Дамп структуры для таблица performance_schema.events_stages_history
...
-- Дамп структуры для таблица performance_schema.events_stages_history_long
...
-- Дамп структуры для таблица performance_schema.events_stages_summary_by_account_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_stages_summary_by_host_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_stages_summary_by_thread_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_stages_summary_by_user_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_stages_summary_global_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_statements_current
...
-- Дамп структуры для таблица performance_schema.events_statements_history
...
-- Дамп структуры для таблица performance_schema.events_statements_history_long
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_by_account_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_by_digest
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_by_host_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_by_thread_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_by_user_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_statements_summary_global_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_waits_current
...
-- Дамп структуры для таблица performance_schema.events_waits_history
...
-- Дамп структуры для таблица performance_schema.events_waits_history_long
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_by_account_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_by_host_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_by_instance
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_by_thread_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_by_user_by_event_name
...
-- Дамп структуры для таблица performance_schema.events_waits_summary_global_by_event_name
...
-- Дамп структуры для таблица performance_schema.file_instances
...
-- Дамп структуры для таблица performance_schema.file_summary_by_event_name
...
-- Дамп структуры для таблица performance_schema.file_summary_by_instance
...
-- Дамп структуры для таблица performance_schema.hosts
...
-- Дамп структуры для таблица performance_schema.host_cache
...
-- Дамп структуры для таблица performance_schema.mutex_instances
...
-- Дамп структуры для таблица performance_schema.objects_summary_global_by_type
...
-- Дамп структуры для таблица performance_schema.performance_timers
...
-- Дамп структуры для таблица performance_schema.rwlock_instances
...
-- Дамп структуры для таблица performance_schema.session_account_connect_attrs
...
-- Дамп структуры для таблица performance_schema.session_connect_attrs
...
-- Дамп структуры для таблица performance_schema.setup_actors
...
-- Дамп структуры для таблица performance_schema.setup_consumers
...
-- Дамп структуры для таблица performance_schema.setup_instruments
...
-- Дамп структуры для таблица performance_schema.setup_objects
...
-- Дамп структуры для таблица performance_schema.setup_timers
...
-- Дамп структуры для таблица performance_schema.socket_instances
...
-- Дамп структуры для таблица performance_schema.socket_summary_by_event_name
...
-- Дамп структуры для таблица performance_schema.socket_summary_by_instance
...
-- Дамп структуры для таблица performance_schema.table_io_waits_summary_by_index_usage
...
-- Дамп структуры для таблица performance_schema.table_io_waits_summary_by_table
...
-- Дамп структуры для таблица performance_schema.table_lock_waits_summary_by_table
...
-- Дамп структуры для таблица performance_schema.threads
...
-- Дамп структуры для таблица performance_schema.users
DROP TABLE IF EXISTS `users`;
CREATE TABLE IF NOT EXISTS `users` (
  `USER` char(16) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `CURRENT_CONNECTIONS` bigint(20) NOT NULL,
